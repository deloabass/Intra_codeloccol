...
function afficheTechnology (list) {
  let vide = "";
  for (let v = 0; v < list.length; v++) {
    vide += `<li><span class="card-link">${list[v]}</span></li>`;
  }
  return vide;
};
      ...
      <div class="card">
        ...
        <div class="card-body w-100 px-0">
          ...
          <ul class="list-unstyled w-100 d-flex justify-content-center flex-wrap">
            ${afficheTechnology(datas.works[i].technology)}
          </ul>
          <div class="row w-100">
...
for (let e = 0; e < datas.experiences.length; e++) {
  ...
  <div class="card h-100">
    ...
    <div class="card-body w-100 px-0">
      ...
      <ul class="list-unstyled w-100 d-flex justify-content-center flex-wrap">
      ${afficheTechnology(datas.experiences[e].technology)}
      </ul>
    </div>
  </div>
</div>`;
